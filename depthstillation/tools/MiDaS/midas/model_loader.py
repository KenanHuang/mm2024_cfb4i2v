...
from tools.MiDaS.midas.dpt_depth import DPTDepthModel
from tools.MiDaS.midas.midas_net import MidasNet
from tools.MiDaS.midas.midas_net_custom import MidasNet_small
from tools.MiDaS.midas.transforms import Resize, NormalizeImage, PrepareForNet
...
default_models = {
    "dpt_beit_large_512": f"{ROOT_PATH}/weights/dpt_beit_large_512.pt",
    "dpt_beit_large_384": f"{ROOT_PATH}/weights/dpt_beit_large_384.pt",
    "dpt_beit_base_384": f"{ROOT_PATH}/weights/dpt_beit_base_384.pt",
    "dpt_swin2_large_384": f"{ROOT_PATH}/weights/dpt_swin2_large_384.pt",
    "dpt_swin2_base_384": f"{ROOT_PATH}/weights/dpt_swin2_base_384.pt",
    "dpt_swin2_tiny_256": f"{ROOT_PATH}/weights/dpt_swin2_tiny_256.pt",
    "dpt_swin_large_384": f"{ROOT_PATH}/weights/dpt_swin_large_384.pt",
    "dpt_next_vit_large_384": f"{ROOT_PATH}/weights/dpt_next_vit_large_384.pt",
    "dpt_levit_224": f"{ROOT_PATH}/weights/dpt_levit_224.pt",
    "dpt_large_384": f"{ROOT_PATH}/weights/dpt_large_384.pt",
    "dpt_hybrid_384": f"{ROOT_PATH}/weights/dpt_hybrid_384.pt",
    "midas_v21_384": f"{ROOT_PATH}/weights/midas_v21_384.pt",
    "midas_v21_small_256": f"{ROOT_PATH}/weights/midas_v21_small_256.pt",
    "openvino_midas_v21_small_256": f"{ROOT_PATH}/weights/openvino_midas_v21_small_256.xml",
}
